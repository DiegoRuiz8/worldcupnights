...
export default function SuccessPage({
  ...
  const fecha = searchParams.fecha || 'your selected date';
  const ticket = searchParams.ticket || 'Entry';
  ...
  return (
    <main style={{
      ...
      <div style={{ maxWidth: '480px', width: '100%', textAlign: 'center' }}>
        ...
        <h1 style={{ color: '#FF6B00', fontSize: '32px', marginBottom: '12px' }}>
          You're in!
        </h1>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <p style={{ color: '#FF6B00', fontWeight: 'bold', margin: '4px 0 0' }}>{fecha}</p>
          </div>
          <div style={{ marginBottom: '16px' }}>
          ...
          <div>
            <span style={{ color: '#666', fontSize: '13px' }}>MEETING POINT</span>
            <p style={{ color: '#fff', margin: '4px 0 0' }}>Plaza Liberación, 9:00 PM</p>
          </div>
        </div>
